...
import kotlinx.android.synthetic.main.fragment_modo_id.view.*
...
class ModoIdFragment: ModoFilmeFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        buscarButton.setOnClickListener(){
            ...
            if (edit_text_id_filme.text.isNotEmpty()) {
                //movieService.buscarFilmePorId(edit_text_id_filme.text.toString())

                //Toast.makeText(layoutFragment.context,"Texto: " + edit_text_id_filme.text.toString(), Toast.LENGTH_SHORT).show()
                ...
                Toast.makeText(layoutFragment.context,"Digite um ID a ser buscado",Toast.LENGTH_SHORT).show()
            }
    ...
    private fun buscar (palavraBusca: String) {
        ...
        movieService.buscarFilmePorId(palavraBusca)
    }
