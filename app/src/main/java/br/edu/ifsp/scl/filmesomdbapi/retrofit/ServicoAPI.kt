...
interface ServicoAPI {
    ...
    */
    ...
    /* Função de requisição. Começa com uma anotação denotando o método HTTP e endpoint da requisição As anotações dos parâmetros da função descrevem o mapeamento para parâmetros do Path da requisição. */
